...
public class SeedServiceImpl implements SeedService {
    private static final String RESOURCE_PATH = "C:\\Software University\\Java Developing\\Spring Data\\Spring-Data-Intro-Exercise-Resources\\files\\";
    ...
    public void seedBooks() throws IOException {
        ...
        for (String s : Files.readAllLines(Path.of(RESOURCE_PATH + BOOKS_FILE_NAME))) {
            if (!s.isBlank()) {
                Book bookObject = getBookObject(s);
                bookRepository1.save(bookObject);
            }
        }
    }
