...
public class PictureServiceImpl implements PictureService {
                ...
                .forEach(p -> {
                    if (p.isValid()) {
                        ...
                        if (pictureByPath != null) {
                            ...
                            message.add(String.format("Successfully imported Picture, with size %.2f", picture.getSize()));
                        }
                    } else {
                        message.add("Invalid Picture");
                    }
    ...
    public String exportPictures() {
        ...
        List<Picture> allBySizeGreaterThanOrderBySize = this.pictureRepository.findAllBySizeGreaterThanOrderBySize(30000);
